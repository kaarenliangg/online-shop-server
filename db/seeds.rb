...
p4 = Product.create(
    ...
    :image => "/images/dog_flea-tick-worm", 
    :cost_price => 10.99, 
    :retail_price => 49.99,
    :quantity => 100
)
...
p11 = Product.create( 
  ...
  :image => '/images/cat_flea-tick-worm_1',
  :cost_price => 32.99,
  :retail_price => 64.99,
  :quantity => 100
)
...
p18 = Product.create(
  ...
  :image => '/images/reptile_flea-tick-worm',
  :cost_price => 8.95,
  :retail_price => 13.95,
  :quantity => 100
)
...
p20 = Product.create(
  ...
  :image => '/images/reptile_accessories',
  :cost_price => 10.95,
  :retail_price => 30.95,
  :quantity => 100
)
...
p25 = Product.create(
  ...
  :image => '/images/bird_flea-tick-worm',
  :cost_price => 10.5,
  :retail_price => 17.5,
  :quantity => 100
)
...
p29 = Product.create(
  ...
  :image => '/images/small-pet_dry-food_1',
  :cost_price => 85.99,
  :retail_price => 139.99,
  :quantity => 100
)
...
p30 = Product.create(
  ...
  :image => '/images/small-pet_wet-food',
  :cost_price => 10.5,
  :retail_price => 23.5,
  :quantity => 100
)
...
p32 = Product.create(
  ...
  :image => '/images/small-pet_flea-tick-worm',
  :cost_price => 14.95,
  :retail_price => 29.95,
  :quantity => 100
)
...
p34 = Product.create(
  ...
  :image => '/images/small-pet_accessories',
  :cost_price => 0.95,
  :retail_price => 5.95,
  :quantity => 100
)
